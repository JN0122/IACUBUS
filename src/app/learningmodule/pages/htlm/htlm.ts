...
export class HtlmPage {
    private readonly safeEntryPoint: ReplaySubject<SafeResourceUrl> =
        new ReplaySubject<SafeResourceUrl>(1);
    title: string = "";
    entryPoint: Observable<SafeResourceUrl> =
        this.safeEntryPoint.asObservable();
