...
export class OpenHtmlLearningModuleAction extends ILIASObjectAction {
    ...
    async execute(): Promise<ILIASObjectActionResult> {
        ...
        try {
            ...
            await this.learningModuleManager.checkAndDownload(
                this.learningModuleObjectId,
                user.id
            );
            this.openHTMLModule();
...
export const OPEN_HTML_LEARNING_MODULE_ACTION_FACTORY: InjectionToken<OpenHtmlLearningModuleAction> =
    new InjectionToken("token for opening html learning module action factory");
