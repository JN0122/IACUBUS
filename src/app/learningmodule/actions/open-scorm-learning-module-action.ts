...
export const OPEN_SCORM_LEARNING_MODULE_ACTION_FACTORY: InjectionToken<OpenScormLearningModuleAction> =
    new InjectionToken("token for open learning module action factory");
