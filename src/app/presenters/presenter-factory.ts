/** presenters */
import {
    ILIASObjectPresenter,
    GenericILIASObjectPresenter,
} from "./object-presenter";
...
export class ILIASObjectPresenterFactory {
    ...
    instance(object: ILIASObject): ILIASObjectPresenter {
        if (object.type == "crs")
            return new CourseObjectPresenter(object, this.themeProvider);
        if (object.type == "fold")
            return new FolderObjectPresenter(object, this.themeProvider);
        if (object.type == "grp")
            return new GroupObjectPresenter(object, this.themeProvider);
        if (object.type == "htlm")
            return new HtmlLearningModuleObjectPresenter(
                object,
                this.themeProvider
            );
        if (object.type == "sahs")
            return new SahsLearningModuleObjectPresenter(
                object,
                this.themeProvider
            );
        if (object.type == "file")
            return new FileObjectPresenter(object, this.themeProvider);
        if (object.isLearnplace())
            return new LearnplaceObjectPresenter(object, this.themeProvider);
