...
describe("IlObjIconComponent", () => {
    ...
    const spyThemeProvider: jasmine.SpyObj<ThemeProvider> =
        createSpyObject(ThemeProvider);
    const spyFeaturePolicy: jasmine.SpyObj<FeaturePolicyService> =
        createSpyObject(FeaturePolicyService);
    ...
    it("should create", () => {
        ...
        component.presenter = new GenericILIASObjectPresenter(
            obj,
            spyThemeProvider
        );
