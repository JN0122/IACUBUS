...
export class MapEntity {
    ...
    @OneToOne(() => VisibilityEntity, <RelationOptions>{
        eager: true,
        onDelete: "RESTRICT",
    })
    @JoinColumn(<JoinColumnOptions>{
...
export class LearnplaceEntity {
    ...
    @OneToOne(() => LocationEntity, (type) => type.learnplace, <
        RelationOptions
    >{ cascade: true, eager: true })
    location: LocationEntity;

    @OneToOne(() => MapEntity, (type) => type.learnplace, <RelationOptions>{
        cascade: true,
        eager: true,
    })
    map: MapEntity;

    @OneToMany(() => VisitJournalEntity, (type) => type.learnplace, <
        RelationOptions
    >{ cascade: true, eager: true })
