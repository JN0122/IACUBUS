...
export const USER_REPOSITORY: InjectionToken<UserRepository> =
    new InjectionToken("token for user repository");
...
export class UserTypeORMRepository
    extends AbstractCRUDRepository<UserEntity, number>
    ...
    async findAuthenticatedUser(): Promise<Optional<UserEntity>> {
        try {
            ...
            throw new RepositoryError(
                Logging.getMessage(error, "Could not find active user.")
            );
        }
    }
}
