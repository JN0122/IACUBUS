...
const pictureBlockJsonSchema: object = {
    ...
    items: {
        ...
        properties: {
            ...
            thumbnail: {
                description:
                    "Base64 encoded image. Thumbnail has a static width of 1280px",
                type: "string",
            },
            url: {
            ...
            hash: {
                description:
                    "sha256 hash of the image returned by the url property of this object",
                type: "string",
            },
        },
        required: [
...
export const blocksJsonSchema: object = {
    ...
    properties: {
        ...
        accordion: {
            ...
            items: {
                description:
                    "Contains the id of all accordions of this leanrplace",
                type: "object",
                properties: {
                    id: {
                        type: "integer",
                    ...
                    expanded: {
                        description:
                            "if the accordion should be expanded by default or not",
                        type: "boolean",
                    },
                    text: textBlockJsonSchema,
                    picture: pictureBlockJsonSchema,
        ...
        map: {
            ...
            properties: {
                ...
                visibility: {
                    type: "string",
                    pattern:
                        "^ALWAYS$|^NEVER$|^ONLY_AT_PLACE$|^AFTER_VISIT_PLACE$",
                },
            },
            required: ["visibility"],
        },
    ...
    examples: [
        {
            ...
            repoPath: ["ILIAS", "Demo srag", "test obj"],
        },
    ],
    required: [
        "objId",
