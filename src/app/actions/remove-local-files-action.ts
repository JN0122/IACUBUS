...
export class RemoveLocalFilesAction extends ILIASObjectAction {
    constructor(
        public title: string,
        public containerObject: ILIASObject,
    ...
    async execute(): Promise<ILIASObjectActionResult> {
        ...
        return new ILIASObjectActionSuccess(
            this.translate.instant("actions.removed_local_files")
        );
    }

    alert(): ILIASObjectActionAlert {
        return {
            title: this.translate.instant("actions.remove_local_files_in", {
                title: this.containerObject.title,
            }),
            subTitle: this.translate.instant(
                "actions.remove_local_files_in_text"
            ),
        };
    }
}
