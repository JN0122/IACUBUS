...
export const DB_MIGRATION: InjectionToken<DBMigration> = new InjectionToken(
    "db migration token"
);
...
export const MIGRATION_SUPPLIER: InjectionToken<MigrationSupplier> =
    new InjectionToken("migration supplier token");
