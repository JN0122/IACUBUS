    ...
    describe("building a link", () => {
        describe("without a installation url", () => {
            it("should throw an illegal state error.", () => {
                ...
                expect(() => subject.build()).toThrowError(
                    IllegalStateError,
                    "Required installation was not found, ILIAS login link build failed."
                );
            });
        });
        ...
        describe("without a client id", () => {
            it("should throw an illegal state error.", () => {
                ...
                expect(() => subject.build()).toThrowError(
                    IllegalStateError,
                    "Required client id was not found, ILIAS login link build failed."
                );
            });
        });
        ...
        describe("with a provided installation id and url", () => {
            it("should build the ILIAS login page link.", () => {
                ...
                subject.installation(url).clientId(clientId);

                expect(subject.build()).toEqual(
                    `${url}/login.php?target=ilias_app_login_page&client_id=${clientId}`
                );
            });
        });
    });
